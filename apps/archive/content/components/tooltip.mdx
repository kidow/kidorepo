---
title: Tooltip
description: 호버 시 보여줄 짧은 텍스트 요소입니다.
keywords: Tooltip, Reactjs, Nextjs, TailwindCSS, Typescript
---

## Example

<Storybook url="https://workshop.dongwook.kim/?path=/docs/components-tooltip-v1--docs" />
...
```tsx
<Tooltip content="Tooltip" position="top" arrow>
  Usage
</Tooltip>
```
...
- [https://daisyui.com/components/tooltip/](https://daisyui.com/components/tooltip/)
