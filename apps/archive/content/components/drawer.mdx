---
title: Drawer
description: 화면의 주요 콘텐츠를 보완하는 콘텐츠를 표시하도록 Dialog 구성 요소를 확장합니다.
keywords: Drawer, Reactjs, Nextjs, TailwindCSS, Typescript
---

## Example

<Storybook url="https://workshop.dongwook.kim/?path=/docs/components-drawer-v1--docs" />
...
```tsx title="containers/drawer/index.tsx"
'use client'
