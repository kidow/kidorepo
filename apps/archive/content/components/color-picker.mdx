...
<Storybook url="https://workshop.kidow.me/?path=/docs/components-colorpicker-v1--docs" />
...
<Blocks>
  ...
  <ModalBlock icon="utils" name="hexToRgb" slug="/utils/hex-to-rgb" />
  <ModalBlock icon="utils" name="rgbToHex" slug="/utils/rgb-to-hex" />
</Blocks>
