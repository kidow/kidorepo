---
title: MonthPicker
description: 연도와 월만 선택할 수 있는 구성 요소입니다.
keywords: MonthPicker, Reactjs, Nextjs, TailwindCSS, Typescript
---

## Example

<Storybook url="https://workshop.dongwook.kim/?path=/docs/components-monthpicker-v1--docs" />
